...
\footnote{\url{https://fr.wikipedia.org/wiki/Patron_de_conception\#cite_note-Osmani-23}}
Dans ce patron, un objet observer comporte une méthode pour inscrire des observateurs. Chaque observateur comporte une méthode Notify. Lorsqu'un message est émis, l'objet appelle la méthode Notify de chaque observateur inscrit.
\footnote{\url{https://fr.wikipedia.org/wiki/Patron_de_conception\#cite_note-25}}}
	\item{\textit{State} :\\
