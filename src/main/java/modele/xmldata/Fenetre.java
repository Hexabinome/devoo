...
public class Fenetre implements Visitable
{
    ...
    public void calculerChemins(PlanDeVille plan, GrapheRealisation graphe, Fenetre fNext)
    {
        ...
        //si on calcule la derniere fentre, il n y a pas une fenetre suivant, du coup fNext sera null
        //TODO: verifier si dans ce cas il serait mieux d'avoir une fentre en plus (juste avec l'entrepot).
        if (fNext != null)
